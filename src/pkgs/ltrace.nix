...
in pkgs.ltrace.overrideAttrs (prev: {
  ...
  patches = prev.patches or [ ] ++ [
    ...
    (pkgs.fetchpatch {
      url =
        "https://raw.githubusercontent.com/openembedded/meta-openembedded/f804417cda245e073c38fbdd6749e0bd49a1c84d/meta-oe/recipes-devtools/ltrace/ltrace/0001-configure-Recognise-linux-musl-as-a-host-OS.patch";
